...
public class MapsActivity extends AppCompatActivity implements
    ...
    private void showRoute() {
        new FetchURL(MapsActivity.this).execute(getUrl(startingLocationMarker.getPosition(), finalLocationMarker.getPosition(), "transit"), "transit");
        LatLngBounds.Builder builder = new LatLngBounds.Builder();
        builder.include(startingLocationMarker.getPosition());
        builder.include(finalLocationMarker.getPosition());
        LatLngBounds bounds = builder.build();
        int mapBoundaryPadding = 100;
        CameraUpdate cu = CameraUpdateFactory.newLatLngBounds(bounds, mapBoundaryPadding);
        mMap.animateCamera(cu);
    }
